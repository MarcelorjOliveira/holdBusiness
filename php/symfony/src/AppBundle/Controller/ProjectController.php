...
class ProjectController extends Controller {
    ...
    public function criarAction(Request $request) {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $project->setSymfonyUser($this->getUser()->getId());
            ...
            $project->setSymfonyUserorm($this->getUser());
        ...
        return $this->render('hold/project/criar.html.twig', array(
                    'form' => $form->createView(), 'objetoSymfonyUser' => $objetoSymfonyUser
        ));
    }
...
//Get the first $amount users starting from a random point
        ...
        return $this->render('hold/project/index.html.twig', array('objetoSymfonyUser' => $objetoSymfonyUser, 'objetoProject' => $objetoProject,
...
//Get the first $amount users starting from a random point
        ...
        return $this->render('hold/project/fotos/index.html.twig', array('objetoSymfonyUser' => $objetoSymfonyUser, 'objetoProject' => $objetoProject, 'galleries' => $galleries,
            'perfil' => $objetoProject->getFotoPerfil(), 'capa' => $resumo->getCapa(), 'links' => $links, 'propaganda' => $propaganda, 'urlPropagandaImage' => $urlPropagandaImage));
    }

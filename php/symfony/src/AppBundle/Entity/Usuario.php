...
class Usuario implements UserInterface, \Serializable {
     ...
     * @var int
     *
     * @ORM\Column(name="DDDFixo", type="integer", nullable=true)
     */
    protected $dDDFixo;
     ...
     * @var int
     *
     * @ORM\Column(name="telFixo", type="integer", nullable=true)
     */
    protected $telFixo;
     ...
     * @var int
     *
     * @ORM\Column(name="DDDCelular", type="integer", nullable=true)
     */
     ...
     * @var int
     *
     * @ORM\Column(name="telCelular", type="integer", nullable=true)
     */

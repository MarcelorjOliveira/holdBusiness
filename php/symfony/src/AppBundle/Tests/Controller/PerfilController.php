...
class PerfilController extends Controller {
    ...
    public function editarAction() {
        ...
        return $this->render('hold/perfil/editar.html.twig', array('objetoSymfonyUser' => $objetoSymfonyUser,
                    'perfil' => $objetoSymfonyUser->getFotoPerfilObject(), 'capa' => $objetoSymfonyUser->getCapaPerfilObject(), 'links' => $links));
    }
    ...
    public function indexAction($id) {
        $objetoSymfonyUser = SymfonyUser::constroiPeloId($id);

        //$objetoSymfonyUser->setStatusConexao(Conexao::statusUnico($this->getUser()->getId(), $objetoSymfonyUser->getId()));
//		$form = $this->createForm(GaleriaForm::class, null);	
        ...
        return $this->render('hold/perfil/index.html.twig', array('objetoSymfonyUser' => $objetoSymfonyUser,
                    'perfil' => $objetoSymfonyUser->getFotoPerfilObject(), 'capa' => $objetoSymfonyUser->getCapaPerfilObject(), 'links' => $links));
    }
    ...
    public function editarAtualizarAction() {
        ...
        return $this->render('hold/perfil/atualizar.html.twig', array('objetoSymfonyUser' => $objetoSymfonyUser,
                    'perfil' => $objetoSymfonyUser->getFotoPerfilObject(), 'capa' => $objetoSymfonyUser->getCapaPerfilObject(), 'links' => $links));}
    ...
    public function atualizarAction(Request $request) {
        ...
        $objeto = SymfonyUser::constroi($this->getUser());

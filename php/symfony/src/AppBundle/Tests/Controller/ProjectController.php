...
//Get the first $amount users starting from a random point
        ...
        return $this->render('hold/pin/index.html.twig', array('objetoSymfonyUser' => $objetoSymfonyUser, 'objetoProject' => $objetoProject,
...
//Get the first $amount users starting from a random point
        ...
        return $this->render('hold/pin/fotos/index.html.twig', array('objetoSymfonyUser' => $objetoSymfonyUser, 'objetoProject' => $objetoProject, 'galleries' => $galleries,
            'perfil' => $objetoProject->getFotoPerfil(), 'capa' => $resumo->getCapa(), 'links' => $links, 'propaganda' => $propaganda, 'urlPropagandaImage' => $urlPropagandaImage));
    }

...
class CommentsAction {
    ...
    public function setFullname($fullname) {
        $this->fullname = $this->getObjetoSymfonyUser()->getTitulo();
        return $this;
    }
    ...
    public function getObjetoSymfonyUser() {
        global $kernel;

        $objetoSymfonyUser = SymfonyUser::constroiPeloId($this->user, $kernel->getContainer()->get('doctrine.orm.entity_manager'));

        return $objetoSymfonyUser;
    }

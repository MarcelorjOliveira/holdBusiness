...
class Project {
     ...
     * @return NormalUser
     */
    public function setSymfonyUser($usuario) {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="SymfonyUser", inversedBy="pins")
     * @ORM\JoinColumn(name="usuario_orm_id", referencedColumnName="id")
     */
    protected $usuarioorm;

    public function setSymfonyUserorm($usuarioorm) {
        $this->usuarioorm = $usuarioorm;
        return $this;
    }

    public function getSymfonyUserorm() {
